...
//---------------------------------------------------------------------------
  ...
  reg bus_error;
  always @(posedge sys_clk)
    if(// bus error check in power up sequence
       ((address == 16'o177700) & bus_read) |
       // write to 160000-167777
       ((address[15:12] == 4'b1110) & negedge_SCTL_n & bus_write )
       )
      bus_error <= 1'b1;
    else 
      bus_error <= 0;
...
//---------------------------------------------------------------------------
// 28KW RAM (160000-177777 is a ROM area)
//---------------------------------------------------------------------------
